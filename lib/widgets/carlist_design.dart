...
class CarlistDesign extends StatelessWidget {
  const CarlistDesign({super.key, required this.carlist});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            "${usdFormatter.format(carlist.price)} / per day",
            style: TextStyle(
              fontSize: 16,
              fontWeight: FontWeight.w600,
              color: onSurface,
