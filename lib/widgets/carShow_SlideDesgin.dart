...
class CarshowSlidedesign extends StatelessWidget {
  const CarshowSlidedesign({super.key, required this.carshow});

  final Carshow carshow;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Container(
                ...
                child: Text(
                  carshow.rating.toStringAsFixed(1),
                  style: TextStyle(
                    color: Colors.white,
          ...
          const SizedBox(height: 10),
          Text(
            "${usdFormatter.format(carshow.price)} / per day",
            style: TextStyle(
              fontSize: 16,
              fontWeight: FontWeight.w600,
              color: onSurface,
